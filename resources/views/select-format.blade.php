...
<body>
    <div class="card">
        <div class="card-header">Universidad La Gran Colombia</div>
        <div class="card-body">
            <h2>Seleccione el Formato</h2>
            <p class="lead mb-4">Seleccione el tipo de acción que desea hacer:</p>
            <p class="description">
                Elija entre crear un Microcurrículo o un Plan de Aprendizaje. Ambos formatos le permitirán gestionar los contenidos educativos de manera eficiente y organizada.
            </p>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <p class="description mt-2">
                        Cree y gestione los microcurrículos de los cursos.
                    </p>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <p class="description mt-2">
                        Organice y estructure los planes de aprendizaje de manera efectiva.
                    </p>
                </div>
            </div>
        </div>
